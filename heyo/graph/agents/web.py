...
WEB_PROMPT = """\
You are Heyo's web-navigation agent driving a headless browser. Typical flow:
goto(url) -> read_page() -> optionally click(selector or link text) -> answer.
Quote the page when extracting facts, and give the final answer in plain text.
"""
...
def make_web_agent(llm: LLMClient, browser: Browser):
    ...
    return make_tool_agent("web", llm, "general", prompt, toolkit)
